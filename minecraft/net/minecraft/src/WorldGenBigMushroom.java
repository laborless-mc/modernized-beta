    ...
    public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
        ...
        if(i4 >= 1 && i4 + i7 + 1 < 256) {
            ...
            if(!z8) {
                ...
                if(i9 != Block.dirt.blockID && i9 != Block.grass.blockID) {
                    return false;
                } else if(!Block.mushroomBrown.canPlaceBlockAt(world1, i3, i4, i5)) {
                    return false;
                } else {
                    world1.setBlockAndMetadata(i3, i4 - 1, i5, Block.dirt.blockID, 0);
                    int i16 = i4 + i7;
                    if(i6 == 1) {
                        i16 = i4 + i7 - 3;
                    }
                        ...
                        for(i13 = i3 - i12; i13 <= i3 + i12; ++i13) {
                            for(int i14 = i5 - i12; i14 <= i5 + i12; ++i14) {
                                ...
                                if((i15 != 0 || i4 >= i4 + i7 - 1) && !Block.opaqueCubeLookup[world1.getBlockId(i13, i11, i14)]) {
                                    world1.setBlockAndMetadata(i13, i11, i14, Block.mushroomCapBrown.blockID + i6, i15);
                                }
                            }
                        }
                    }
                    ...
                    for(i11 = 0; i11 < i7; ++i11) {
                        ...
                        if(!Block.opaqueCubeLookup[i12]) {
                            world1.setBlockAndMetadata(i3, i4 + i11, i5, Block.mushroomCapBrown.blockID + i6, 10);
                        }
                    }
