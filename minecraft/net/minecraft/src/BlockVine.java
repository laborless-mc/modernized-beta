...
public class BlockVine extends Block {
    ...
    private boolean canBePlacedOn(int i1) {
        if(i1 == 0) {
            ...
            return block2.renderAsNormalBlock() && block2.blockMaterial.isSolid();
        }
    }
...
//        if(biome == BiomeGenBase.swampland) { return Integer.parseInt(BiomeGenBase.swampColor, 16); }
    ...
    public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
        if(!world1.multiplayerWorld && !this.canVineStay(world1, i2, i3, i4)) {
    ...
    public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
        if(!world1.multiplayerWorld && world1.rand.nextInt(4) == 0) {
            byte b6 = 4;
            int i7 = 5;
            boolean z8 = false;
            ...
            if(i10 == 1 && i3 < 255 && world1.isAirBlock(i2, i3 + 1, i4)) {
                ...
                if(i10 >= 2 && i10 <= 5 && (i9 & 1 << i11) == 0) {
                    ...
                    if(i12 != 0 && Block.blocksList[i12] != null) {
                        if(Block.blocksList[i12].blockMaterial.getIsTranslucent() && Block.blocksList[i12].renderAsNormalBlock()) {
