                ...
                if((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < 256 - i6 - 1) {
                    ...
                    for(int i14 = i4 + i6 - 2 - random2.nextInt(4); i14 > i4 + i6 / 2; i14 -= 2 + random2.nextInt(4)) {
                        ...
                        for(int i13 = 0; i13 < 5; ++i13) {
                            ...
                            world1.setBlockAndMetadata(i11, i14 - 3 + i13 / 2, i12, Block.wood.blockID, this.woodMetadata);
                        }
                    }
                    ...
                    for(i10 = 0; i10 < i6; ++i10) {
                        ...
                        if(i11 == 0 || i11 == Block.leaves.blockID) {
                            world1.setBlockAndMetadata(i3, i4 + i10, i5, Block.wood.blockID, this.woodMetadata);
                            if(i10 > 0) {
                                if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 - 1, i4 + i10, i5)) {
                                    world1.setBlockAndMetadata(i3 - 1, i4 + i10, i5, Block.vine.blockID, 8);
                                }

                                if(random2.nextInt(3) > 0 && world1.isAirBlock(i3, i4 + i10, i5 - 1)) {
                                    world1.setBlockAndMetadata(i3, i4 + i10, i5 - 1, Block.vine.blockID, 1);
                                }
                            }
                        }
                        ...
                        if(i10 < i6 - 1) {
                            ...
                            if(i11 == 0 || i11 == Block.leaves.blockID) {
                                world1.setBlockAndMetadata(i3 + 1, i4 + i10, i5, Block.wood.blockID, this.woodMetadata);
                                if(i10 > 0) {
                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 + 2, i4 + i10, i5)) {
                                        world1.setBlockAndMetadata(i3 + 2, i4 + i10, i5, Block.vine.blockID, 2);
                                    }

                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 + 1, i4 + i10, i5 - 1)) {
                                        world1.setBlockAndMetadata(i3 + 1, i4 + i10, i5 - 1, Block.vine.blockID, 1);
                                    }
                                }
                            }
                            ...
                            if(i11 == 0 || i11 == Block.leaves.blockID) {
                                world1.setBlockAndMetadata(i3 + 1, i4 + i10, i5 + 1, Block.wood.blockID, this.woodMetadata);
                                if(i10 > 0) {
                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 + 2, i4 + i10, i5 + 1)) {
                                        world1.setBlockAndMetadata(i3 + 2, i4 + i10, i5 + 1, Block.vine.blockID, 2);
                                    }

                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 + 1, i4 + i10, i5 + 2)) {
                                        world1.setBlockAndMetadata(i3 + 1, i4 + i10, i5 + 2, Block.vine.blockID, 4);
                                    }
                                }
                            }
                            ...
                            if(i11 == 0 || i11 == Block.leaves.blockID) {
                                world1.setBlockAndMetadata(i3, i4 + i10, i5 + 1, Block.wood.blockID, this.woodMetadata);
                                if(i10 > 0) {
                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3 - 1, i4 + i10, i5 + 1)) {
                                        world1.setBlockAndMetadata(i3 - 1, i4 + i10, i5 + 1, Block.vine.blockID, 8);
                                    }

                                    if(random2.nextInt(3) > 0 && world1.isAirBlock(i3, i4 + i10, i5 + 2)) {
                                        world1.setBlockAndMetadata(i3, i4 + i10, i5 + 2, Block.vine.blockID, 4);
                                    }
                                }
                            }
                        }
            ...
            for(int i11 = i2 - i10; i11 <= i2 + i10 + 1; ++i11) {
                ...
                for(int i13 = i3 - i10; i13 <= i3 + i10 + 1; ++i13) {
                    ...
                    if((i12 >= 0 || i14 >= 0 || i12 * i12 + i14 * i14 <= i10 * i10) && (i12 <= 0 && i14 <= 0 || i12 * i12 + i14 * i14 <= (i10 + 1) * (i10 + 1)) && (random6.nextInt(4) != 0 || i12 * i12 + i14 * i14 <= (i10 - 1) * (i10 - 1)) && !Block.opaqueCubeLookup[world1.getBlockId(i11, i8, i13)]) {
                        world1.setBlockAndMetadata(i11, i8, i13, Block.leaves.blockID, this.leavesMetadata);
                    }
                }
            }
        }
